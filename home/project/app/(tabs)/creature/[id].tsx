...
export default function CreatureDetailScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Header with creature number and favorite button */}
      <View style={[styles.header, { backgroundColor: getBackgroundColor(creature.category_id) }]}>
        <TouchableOpacity style={styles.backButton} onPress={() => router.back()}>
          <ChevronLeft color="white" size={28} />
        </TouchableOpacity>
        <Text style={styles.creatureId}>#{creature.creature_id}</Text>
        <TouchableOpacity style={styles.favoriteButton} onPress={toggleFavorite}>
          <Heart color="white" fill={isFavorite ? "white" : "none"} size={28} />
        </TouchableOpacity>
      </View>

      {/* Creature image/emoji section */}
      <View style={[styles.emojiContainer, { backgroundColor: getBackgroundColor(creature.category_id) }]}>
        <Text style={styles.emoji}>{getEmojiForCreature(creature.category_id)}</Text>
      </View>
      ...
      <ScrollView style={styles.contentContainer}>
        ...
        {activeTab === 'stats' && (
          <View style={styles.tabContent}>
            <View style={styles.statBar}>
              <Text style={styles.statBarLabel}>Speed</Text>
              <View style={styles.statBarContainer}>
                <View style={[styles.statBarFill, { width: '65%', backgroundColor: '#0077B6' }]} />
              </View>
              <Text style={styles.statBarValue}>65</Text>
            </View>
            
            <View style={styles.statBar}>
              <Text style={styles.statBarLabel}>Strength</Text>
              <View style={styles.statBarContainer}>
                <View style={[styles.statBarFill, { width: '70%', backgroundColor: '#0077B6' }]} />
              </View>
              <Text style={styles.statBarValue}>70</Text>
            </View>
            
            <View style={styles.statBar}>
              <Text style={styles.statBarLabel}>Agility</Text>
              <View style={styles.statBarContainer}>
                <View style={[styles.statBarFill, { width: '80%', backgroundColor: '#0077B6' }]} />
              </View>
              <Text style={styles.statBarValue}>80</Text>
            </View>
            
            <View style={styles.statBar}>
              <Text style={styles.statBarLabel}>Intelligence</Text>
              <View style={styles.statBarContainer}>
                <View style={[styles.statBarFill, { width: '75%', backgroundColor: '#0077B6' }]} />
              </View>
              <Text style={styles.statBarValue}>75</Text>
            </View>
            
            <View style={styles.statBar}>
              <Text style={styles.statBarLabel}>Rarity</Text>
              <View style={styles.statBarContainer}>
                <View style={[styles.statBarFill, { width: `${creature.points / 5}%`, backgroundColor: '#0077B6' }]} />
              </View>
              <Text style={styles.statBarValue}>{creature.points / 5}</Text>
            </View>
          </View>
        )}
        ...
        {activeTab === 'habitat' && (
          <View style={styles.tabContent}>
            <View style={styles.infoSection}>
              <Text style={styles.infoTitle}>Natural Habitat</Text>
            ...
            <View style={styles.habitatImagePlaceholder}>
              <Text style={styles.habitatEmoji}>🌊</Text>
            </View>
            
            <Text style={styles.habitatDescription}>
              This species can be found in various marine environments, adapting to different conditions based on seasonal changes and food availability.
            </Text>
          </View>
        )}
